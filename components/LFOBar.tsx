...
import SawWaveIcon from "../assets/saw-down.svg"
import SawWaveExpIcon from "../assets/saw-exp.svg"
import SawWaveLogIcon from "../assets/saw-log.svg"
import TriangleWaveIcon from "../assets/tri-half.svg"
import SineWaveIcon from "../assets/sine-half.svg"
...
const LFOBarType: React.FunctionComponent<LFOTypeProps & WithJUCEComboBoxProps> = ({color, label, parameterID, value, onChange}) => {
    ...
    const waves = {
        sawExp: <SawWaveExpIcon className="wave-icon" style={{filter}}/>,
        saw: <SawWaveIcon className="wave-icon" style={{filter}}/>,
        sawLog: <SawWaveLogIcon className="wave-icon" style={{filter}}/>,
